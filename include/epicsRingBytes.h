 ...
 * @date 15. Jul 1999
 *
 * EpicsRingBytes provides methods for creating and using ring buffers
 ...
 * @param id RingbufferID returned by a former epicsRingBytesCreate 
 * @param value Move nbytes from value to the ring buffer if there is enough
 ...
 * be zero if insufficient space exists.
 */
 ...
 * since the water mark was last reset. A new ring buffer starts with a water
 * mark of 0.
 * @param id RingbufferID returned by a former epicsRingBytesCreate 
